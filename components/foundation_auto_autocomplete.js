...
const CLASS_ID = Components.ID("9ada4179-f4ed-41c4-9da8-78596358eb68"); // ← Change this
const CLASS_NAME = "Foundation Auto complete";
const CONTRACT_ID = "@mozilla.org/autocomplete/search;1?name=foundation_auto-autocomplete";
